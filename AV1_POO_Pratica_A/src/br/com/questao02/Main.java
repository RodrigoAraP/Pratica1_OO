    ...
    public static void main(String[] args) {
        ...
        while (true){
            ...
            if(escolha == 1){
                ...
                int qtde = sc.nextInt();
                DistribuicaoAlimento prjAlimento = new DistribuicaoAlimento(name, desc, endereco, dataInit, dataEnd, descAlimento, qtde);
                ...
                TrabalhoVoluntario prjAlimento = new TrabalhoVoluntario(name, desc, endereco, dataInit, dataEnd, tipoTrabalho, duracaoTrabalho);
